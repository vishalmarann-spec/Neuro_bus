...
No selection manifest is committed yet because the current 20-case corpus does not meet the size or human-review gates. Once a manifest has been used for tuning or evaluation, do not rewrite it; create a new version.
