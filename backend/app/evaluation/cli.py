...
from app.evaluation.io import load_gold_case_files, load_predictions
...
def main() -> None:
    ...
    scorecards = score_models(load_gold_case_files(args.gold), load_predictions(args.predictions))
